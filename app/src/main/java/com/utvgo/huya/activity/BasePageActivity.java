            ...
            switch (msg.what) {
                case MSG_TURN_PAGE:
                    if (tmpPageIndex <= pageTotal && tmpPageIndex > 0) {
                        pageNo = (int) msg.obj;
                        getData();
                        ToastUtil.showInCenter(BasePageActivity.this, "已跳转至" + pageNo + "页");
                    } else {
                        ToastUtil.showInCenter(BasePageActivity.this, "不存在" + tmpPageIndex + "页");
                    }
                    tmpPageIndex = -1;
                    break;
            }
        ...
        focusScene.init(new ISceneListener() {
            ...
            public void onExecute(Intent intent) {
                ...
                if (intent.hasExtra("_scene")) {
                    ...
                    Toast.makeText(BasePageActivity.this, command, Toast.LENGTH_LONG).show();
