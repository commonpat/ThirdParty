...
public class BeanTopic implements Serializable {
    ...
    private List<OpItem> utvgoSubjectRecordList;
    ...
    public List<OpItem> getUtvgoSubjectRecordList() {
        return utvgoSubjectRecordList;
    }

    public void setUtvgoSubjectRecordList(List<OpItem> utvgoSubjectRecordList) {
